"""
Queue Length Prediction API - Enhanced with auth, audit, and risk score.
"""

from fastapi import APIRouter, HTTPException, Depends, Request
from app.models.schemas import PredictionInput, QueueLengthResponse
...
async def predict_queue_length(
    ...
    try:
        ...
        audit_logger.log(
            ...
            action="queue_length_prediction",
            endpoint="/api/predict/queue-length",
            status="success",
            ip_address=client_ip,
            details=f"Predicted: {ql:.0f} people in queue"
        )
        
        return QueueLengthResponse(
            predicted_queue_length=ql,
